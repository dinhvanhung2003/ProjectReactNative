...
const ChartDetails = ({ route, navigation }) => {
  ...
  >
    {/* Overlay with Label and Country */}
    <View style={tw`absolute inset-0 bg-black bg-opacity-25 rounded-lg justify-center items-center`}>
      <Text style={tw`text-white text-base font-bold`}>{chart.label}</Text>
      <Text style={tw`text-white text-xs`}>{chart.country}</Text>
    </View>
  </ImageBackground>
